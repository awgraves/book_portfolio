      ...
      <template v-slot:content>
        <Page :pageIndex="0" :canFlip="true" key="ct-0">
          <template v-slot:front>
            ...
            <img
              ...
              src="/images/clinicaltrials/search_params.png"
            />
            <p style="margin-top: 5%">
              Our lab needed a fast, easy way to provide our patients with
              relevant clinical trials on their reports.
              <br /><br />
              I built a system from the ground up that has saved our lab $700 a
              month since we no longer need to pay a 3rd party for a similar
              service.
            </p>
          ...
          <template v-slot:back>
            ...
            <img
              @click.stop="zoom($event)"
              src="/images/clinicaltrials/trial_email.png"
            />
            <p>
        ...
        <Page :pageIndex="1" :canFlip="true" key="ct-1">
          <template v-slot:front>
            ...
            <img
              @click.stop="zoom($event)"
              src="/images/clinicaltrials/oncotree_keyword_manager.png"
            />
            <p>
              The core text mining algorithm relies on keywords to determine
              which type(s) of cancer a trial is targeting.
              <br /><br />An Oncotree Keywords Manager UI makes it easy to
              add/modify keyword associations for all
          ...
          <template v-slot:back>
            ...
            <img
              @click.stop="zoom($event)"
              src="/images/clinicaltrials/trial_results.png"
            />
            <p style="margin-top: 5%">
              Each patient's case page has a trials widget. Their age, sample
              tissue type, and genetic alterations are autopopulated as search
              params.
              <br /><br />Results are sorted according to popularity in our
              system and local availability if patient is from UPMC.
            </p>
        ...
        <Page :pageIndex="2" :canFlip="true" key="ct-2">
          <template v-slot:front>
            ...
            <img
              @click.stop="zoom($event)"
              src="/images/clinicaltrials/search_NCT.png"
            />
            <p style="margin-top: 5%">
              Qualified users simply click a checkbox to include a trial on a
              patient's final report.
              <br /><br />Orange genes signify relevancy to the patient. At
              least one will be orange, but multiple can be specified if
              appropriate.
            </p>
          ...
          <template v-slot:back>
            ...
            <img
              @click.stop="zoom($event)"
              src="/images/clinicaltrials/trials_on_report.png"
            />
            <p style="margin-top: 5%">
              Selected trials are listed on a patient's final report.
              <br /><br />If both the patient and the trial are local, the
              <b><i>*Available in Pittsburgh</i></b>
              text appears next to that trial and it gets sorted to the top of
              the list.
            </p>
