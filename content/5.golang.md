...
bgColor: "#00ADD8"
previewBlurb: "I worked on several production Go microservices at Codecademy."
...
#front-text
I worked on several production Go microservices at Codecademy:

- Re-architected our docs-service
...
#back-text
The docs-service transforms the markdown files in Codecademy's [docs github repo](https://github.com/codecademy/docs) into a queryable data source which powers the docs resources [on our site](https://www.codecademy.com/resources/docs).
...
#back-text
Codecademy had multiple payment vendors ([Recurly](https://recurly.com/), [PayTM](https://paytm.com/), and [Stripe](https://stripe.com/)), each of which handled coupon discounts differently.
